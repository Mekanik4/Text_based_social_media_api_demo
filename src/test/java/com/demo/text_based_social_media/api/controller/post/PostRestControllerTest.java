package com.demo.text_based_social_media.api.controller.post;
...
public class PostRestControllerTest {
    ...
    void shouldCreatePost() throws Exception {
        mockMvc.perform(post("/users/me/posts/new")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("authorization", token.substring(10, token.length() - 2))
                        .content("{\"context\": \"This is a new post\"}"))
                .andExpect(status().isOk());
    }

    @Test
    void shouldGetAllPostsWithComments() throws Exception {
    ...
    @Test
    void shouldGetAllFollowingPosts() throws Exception {
        mockMvc.perform(get("/users/me/following/posts")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("authorization", token.substring(10, token.length() - 2)))
                .andExpect(status().isOk());
    }
